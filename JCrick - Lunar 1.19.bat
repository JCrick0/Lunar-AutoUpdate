@echo off & setlocal EnableDelayedExpansion && set "_v=1.19" & set "_vv=!_v:.=!" & set "_v_v=!_vv:~0,1!_!_vv:~1!" & set "_title=Lunar AutoUpdate Launcher"
title %_title%
...
echo Tu nombre de usuario%_lastunamed%
set /p "_username=> "
...
echo Coloca RAM en MB - 1GB = 1024MB (recomendado: 4096)%_lastramd%
set /p "_rammb=> "
...
title %_title% ^| usuario: %_username%
...
cls
title JCrick - Lunar %_vv% | %_username%
goto start
exit
